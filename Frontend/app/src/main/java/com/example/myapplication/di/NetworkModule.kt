...
object NetworkModule {
     ...
     *
     * Note: Using HEADERS level instead of BODY to avoid OutOfMemoryError
     * when uploading large files (e.g., videos). BODY level would load
     * the entire file into memory for logging.
     */
    @Provides
    @Singleton
